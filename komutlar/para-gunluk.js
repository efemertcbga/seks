...
exports.run = async (bot, message, args) => {
    ...
    if (lastDaily !== null && cooldown - (Date.now() - lastDaily) > 0) {
        ...
        .setColor('#FFBA4A')
        .setDescription(`<:unlemgif:840370869578760224> Bunu zaten topladın lütfen bekleyin **${timeObj.hours} saat ${timeObj.minutes} dakika**!`)
        .setFooter(`ToxyBot Ekonomi Sistemi`)
