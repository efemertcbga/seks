...
if (!args.length) {
          ...
          console.log(response)
                ...
                .catch((error) => {
          message.channel.send('<:hayir:839223750457163867> Hata \n Lütfen ülke girerken global olarak giriniz. Örnek: Turkey veya turkey şeklinde girebilirsiniz.<:hayir:839223750457163867> ')
                    console.log(error);
                });
        }
}
