...
message.channel.send(e2)
    ...
    if (meslek > 0) {
      message.channel.send(`<:hayir:839223750457163867> Sen bu mesleği önceden olmuşsun zaten.`)

    } else if (meslek > 0) {
      const embed = new Discord.MessageEmbed()
        .setDescription(`<:hayir:839223750457163867> Zaten madenci mesleğindesin`)
    .setColor('RED')
      .setTimestamp() // emojileri mainde tanımlamışda zaten emojiler gözükmücek silelim bence? Mecbur tanimladigi yeri alicaz yoksa kod calismaz
      message.channel.send({embed})
  
  } else if (para < 1000) {
        message.channel.send(`<:hayir:839223750457163867> Madenci olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **1000TL**.`)
    } else if  (para > 1000) {
      const madenciE = new Discord.MessageEmbed()
      .setColor('RANDOM')
      .setDescription(`<:evet:840367216738041888> Yeni mesleğiniz **madenci**\n:tada: Mesleğinde başarılar.`)
      .setTimestamp()
    ...
    if (x === 'çiftçi') {
      ...
      if (meslek < 1) {
        message.channel.send(`<:hayir:839223750457163867> Lütfen meslekleri sırasıyla ol\n **${prefix}meslek** Yazarak mesleğini ve sırayı görebilirsin`)
        db.add(`meslek_${message.author.id}`, -1)
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`<:hayir:839223750457163867> Zaten çiftçi mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`<:hayir:839223750457163867> Çiftçi olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **2000TL**.`)
      } else if  (para > 2000) {
        const madenciE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`<:evet:840367216738041888> Yeni mesleğiniz **çiftçi**\n:tada: Mesleğinde başarılar.`)
        .setTimestamp()
       message.channel.send(madenciE)
    ...
    if (x === 'tamirci') {
      ...
      if (meslek < 302) {
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`<:hayir:839223750457163867> Zaten tamirci mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`<:hayir:839223750457163867> tamirci olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **3000TL**.`)
      } else if  (para > 3000) {
        const madenciE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`<:evet:840367216738041888> Yeni mesleğiniz **tamirci**\n:tada: Mesleğinde başarılar.`)
        .setTimestamp()
       message.channel.send(madenciE)
       db.delete(`meslekA_${message.author.id}`)
       db.add(`meslek_${message.author.id}`, 200)
    ...
    if (x === 'emlakçı') {
      ...
      if (meslek < 302) {
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`<:hayir:839223750457163867> Zaten emlakçı mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`<:hayir:839223750457163867> emlakçı olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **5000TL**.`)
      } else if  (para > 5000) {
        const emlakçıE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`<:evet:840367216738041888> Yeni mesleğiniz **emlakçı**\n:tada: Mesleğinde başarılar.`)
        .setTimestamp()
    ...
    if (x === 'mimar') {
      ...
      if (meslek < 302) {
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`<:hayir:839223750457163867> Zaten mimar mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`<:hayir:839223750457163867> mimar olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **10000TL**.`)
      } else if  (para > 10000) {
        const mimarE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`<:evet:840367216738041888> Yeni mesleğiniz **mimar**\n:tada: Mesleğinde başarılar.`)
        .setTimestamp()
    ...
    if (x === 'doktor') {
      ...
      if (meslek < 302) {
        ...
        const embed = new Discord.MessageEmbed()
        .setDescription(`<:hayir:839223750457163867> Zaten doktor mesleğindesin`)
        .setColor('RED')
        .setTimestamp()
        message.channel.send({embed})
        db.add(`meslek_${message.author.id}`, -1)
      ...
      db.add(`meslek_${message.author.id}`, -1)   
      message.channel.send(`<:hayir:839223750457163867> doktor olmak için yeterli paran bulunmuyor. \n Gerekli olan para: **20000TL**.`)
      } else if  (para > 20000) {
        const doktorE = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setDescription(`<:evet:840367216738041888> Yeni mesleğiniz **doktor**\n:tada: Mesleğinde başarılar.`)
        .setTimestamp()
