...
let gay = bebek[Math.floor(Math.random() * bebek.length)]
let gey = msg.mentions.members.first()
     if (!gey) return msg.channel.send(':x:  Kimi Sevdiğini Etiketle!') 
  msg.channel.send(`${msg.author}, ${gey} İle Olan Aşkını ${gay}.`)
    }
