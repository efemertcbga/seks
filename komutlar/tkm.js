...
exports.run = async (client, msg, args) => {
    ...
    if (!args[0]) {
        return msg.channel.send(`Lütfen seçimini yap taş, kağıt yada makas & ${prefix}tkm <taş,kağıt,makas>`);
    }
    ...
    if (!rps.includes(choice)) {
        return msg.channel.send(`Lütfen seçimini yap taş, kağıt yada makas & ${prefix}tkm <t,k,m>`);
    }
